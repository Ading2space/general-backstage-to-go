  ...
  <a-form @submit="handleSubmit" :form="form">
    ...
    <a-form-item label="任务负责人" :label-col="labelCol" :wrapper-col="wrapperCol">
      <a-select v-decorator="['owner', { rules: [{ required: true, message: '请选择开始时间' }] }]">
        <a-select-option :value="0">负责人1</a-select-option>
        <a-select-option :value="1">负责人2</a-select-option>
        <a-select-option :value="2">负责人3</a-select-option>
        <a-select-option :value="3">负责人4</a-select-option>
      </a-select>
    </a-form-item>
